...
<html lang="en">
    ...
    <title>Online Time Table Generator</title>
...
<script src="js/bootstrap.min.js"></script>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand"><font color="#FF0000">Online TimeTable Generator by SAMEER SHARMA</font></a>
    </div>
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="../timetable/staff/index.php">Teacher Login</a></li>
...
<header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1>ONLINE TIMETABLE GENERATION SYSTEM </h1>
                <hr>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-12 text-center">
                        <h2 class="section-heading">About Online TimeTable Generation System </h2>
                        <hr class="primary">
                    </div>
                    ...
                    <div class="row mb90">
                        <div class="col-md-12 text-justify">
                                ...
                                <p>Most colleges have a number of different courses and each course has a number of subjects. Now there are limited faculties, each faculty teaching more than one subjects. Implementing an Online Timetable Generation System for colleges streamlines the scheduling process, significantly reducing the time and effort invested in manual scheduling. This automated system optimizes resource utilization, considering factors like room availability, faculty preferences, and student needs. It enhances accuracy, minimizing scheduling conflicts and errors that may arise in traditional methods. With real-time accessibility, faculty and students can conveniently view and manage their schedules, fostering better communication and coordination. The system's flexibility allows for quick adjustments, ensuring adaptability to unforeseen events. Overall, an Online Timetable Generation System enhances efficiency, providing a modern solution for the dynamic scheduling requirements of college environments.</p>
                        </div>
